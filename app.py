...
# =========================================
# =========================================
# EMAIL & SECRET KEY CONFIG – RAILWAY READY (NO HARD-CODED PASSWORD)
# =========================================
import os
...
app.config['SECRET_KEY'] = os.getenv('SECRET_KEY', 'dev-fallback-key-only-for-local')
...
# Make sure this exists in your config or app.py
serializer = URLSafeTimedSerializer(app.config['SECRET_KEY'])
...
# =========================================
# =========================================
# FORGOT & RESET PASSWORD ROUTES – 100% WORKING (2025)
# =========================================
...
def forgot_password():
    try:
        ...
        success_msg = {"success": True, "message": "If an account exists with this email, a reset link has been sent."}
        if not user:
        ...
        msg = Message(
            subject="Password Reset – Sentellect",
            recipients=[email],
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
            ...
            <p>We received a request to reset your Sentellect password.</p>
            <p>Click the button below to set a new password:</p>
            <p style="text-align: center; margin: 30px 0;">
                <a href="{reset_link}" 
                   style="background:#1e40af; color:white; padding:14px 28px; text-decoration:none; border-radius:8px; font-weight:bold;">
                    Reset Password
                </a>
            </p>
...
def reset_password_page(token):
    try:
        ...
        return "<h1>Reset link has expired.</h1>"
    except BadSignature:
